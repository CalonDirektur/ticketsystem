...
class Admin1 extends CI_Controller
{
	...
	public function approve($produk = NULL, $kategori, $id)
	{
		if ($produk == 'mytalim') {
			...
			$this->session->set_flasdata('berhasil_approve', '<div class="alert alert-success" role="alert"> Berhasil Approve request support My Talim!</div>');
			redirect('/');
		}
		...
		if ($produk == 'myhajat' && $kategori == 'sewa') {
			...
			$this->session->set_flasdata('berhasil_approve', '<div class="alert alert-success" role="alert"> Berhasil Approve request support My Hajat!</div>');
			redirect('/');
		}
		...
		if ($produk == 'myihram') {
			...
			$this->session->set_flasdata('berhasil_approve', '<div class="alert alert-success" role="alert"> Berhasil Approve request support My Ihram!</div>');
			redirect('/');
		}

		if ($produk == 'mysafar') {
			$this->Aksi_Admin1_m->approve('tb_my_safar', ['id_mysafar' => $id]);
			$this->session->set_flasdata('berhasil_approve', '<div class="alert alert-success" role="alert"> Berhasil Approve request support My Safar!</div>');
			redirect('/');
		}

		if ($produk == 'nst') {
			$this->Aksi_Admin1_m->approve('tb_nst', ['id_nst' => $id]);
			$this->session->set_flasdata('berhasil_approve', '<div class="alert alert-success" role="alert"> Berhasil Approve request support NST!</div>');
			redirect('/');
		}

		if ($produk == 'aktivasi_agent') {
			$this->Aksi_Admin1_m->approve('tb_aktivasi_agent', ['id_agent' => $id]);
			$this->session->set_flasdata('berhasil_approve', '<div class="alert alert-success" role="alert"> Berhasil Approve request support Aktivasi Agent!</div>');
			redirect('/');
		}
	}
	...
	public function reject($produk = NULL, $kategori, $id)
	{
		if ($produk == 'mytalim') {
			...
			$this->session->set_flasdata('berhasil_reject', '<div class="alert alert-success" role="alert"> Berhasil Reject request support Aktivasi Agent!</div>');
			redirect('/');
		}
		if ($produk == 'myhajat' && $kategori == 'renovasi') {
		...
		if ($produk == 'lead_management') {
			...
			$this->session->set_flasdata('berhasil_approve', '<div class="alert alert-success" role="alert"> Berhasil Reject request support Aktivasi Agent!</div>');
			redirect('/');
		}
	}
}
