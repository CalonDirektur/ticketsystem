...
class Admin1 extends CI_Controller
{
	...
	public function approve($produk = NULL, $kategori, $id)
	{
		...
		if ($produk == 'myfaedah' && $kategori == 'bangunan') {
			$this->Aksi_Admin1_m->approve('tb_my_faedah_bangunan', ['id_bangunan' => $id]);
		...
		if ($produk == 'myfaedah' && $kategori == 'qurban') {
			$this->Aksi_Admin1_m->approve('tb_my_faedah_qurban', ['id_qurban' => $id]);
		...
		if ($produk == 'myfaedah' && $kategori == 'elektronik') {
			$this->Aksi_Admin1_m->approve('tb_my_faedah_elektronik', ['id_elektronik' => $id]);
		...
		if ($produk == 'myfaedah' && $kategori == 'modal') {
			$this->Aksi_Admin1_m->approve('tb_my_faedah_modal', ['id_modal' => $id]);
		...
		if ($produk == 'myfaedah' && $kategori == 'lainnya') {
			$this->Aksi_Admin1_m->approve('tb_my_faedah_lainnya', ['id_myfaedah_lainnya' => $id]);
	...
	public function reject($produk = NULL, $kategori, $id)
	{
		...
		if ($produk == 'myfaedah' && $kategori == 'bangunan') {
			$this->Aksi_Admin1_m->reject('tb_my_faedah_bangunan', ['id_bangunan' => $id]);
		...
		if ($produk == 'myfaedah' && $kategori == 'qurban') {
			$this->Aksi_Admin1_m->reject('tb_my_faedah_qurban', ['id_qurban' => $id]);
		...
		if ($produk == 'myfaedah' && $kategori == 'elektronik') {
			$this->Aksi_Admin1_m->reject('tb_my_faedah_elektronik', ['id_elektronik' => $id]);
		...
		if ($produk == 'myfaedah' && $kategori == 'modal') {
			$this->Aksi_Admin1_m->reject('tb_my_faedah_modal', ['id_modal' => $id]);
		...
		if ($produk == 'myfaedah' && $kategori == 'lainnya') {
			$this->Aksi_Admin1_m->reject('tb_my_faedah_lainnya', ['id_myfaedah_lainnya' => $id]);
