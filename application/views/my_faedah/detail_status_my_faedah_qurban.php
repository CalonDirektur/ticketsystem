        ...
        <div class="col-lg-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <!-- Nama Penyedia qurban -->
              <div class="form-group">
                <label for="nama_penyedia_qurban">Nama Penyedia Barang </label>
                <input name="nama_penyedia_qurban" id="nama_penyedia_qurban" type="text" class="form-control enable" value="<?= $data->nama_penyedia ?>" readonly required placeholder="Nama Penyedia Barang">
              </div>
              <!-- Jenis Penyedia Barang -->
              <div class="form-group">
                <label for="jenis_penyedia_qurban">Jenis Penyedia Barang </label>
                <select class="form-control enable" name="jenis_penyedia_qurban" id="jenis_penyedia_qurban" required disabled>
            ...
            <div class="card-footer">
              ...
              <?php if ($this->session->userdata('level') == 2 && $data->id_approval == 0) { ?>
                ...
                <a class="btn btn-info" onclick="return confirm('Apakah Anda yakin MENYETUJUI request support ini?')" href="<?= base_url('Admin1/approve/myfaedah/qurban/' . $data->id_qurban) ?>">Approve</a>
                <a class="btn btn-danger" onclick="return confirm('Apakah Anda yakin MENOLAK request support ini?')" href="<?= base_url('Admin1/reject/myfaedah/qurban/' . $data->id_qurban) ?>">Reject</a>
              <?php } ?>
              <?php if ($this->session->userdata('level') == 3 && $data->id_approval == 2) { ?>

                <a class="btn btn-info" onclick="return confirm('Apakah Anda yakin MENYELESAIKAN request support ini?')" href="<?= base_url('Admin2/complete/myfaedah/qurban/' . $data->id_qurban) ?>">Approve</a>
                <a class="btn btn-danger" onclick="return confirm('Apakah Anda yakin MENOLAK request support ini?')" href="<?= base_url('Admin2/reject/myfaedah/qurban/' . $data->id_qurban) ?>">Reject</a>
              <?php } ?>
              <!-- Tombol Aksi ini akan muncul untuk Admin Superuser -->
              <?php if ($this->session->userdata('level') == 5) { ?>

                <a class="btn btn-info mt-1" href="<?= base_url('Superuser/complete/myfaedah/qurban/' . $data->id_qurban) ?>">Complete</a>
                <a class="btn btn-danger mt-1" href="<?= base_url('Superuser/reject/myfaedah/qurban/' . $data->id_qurban) ?>">Reject</a>
              <?php } ?>
            </div>
          </div>
