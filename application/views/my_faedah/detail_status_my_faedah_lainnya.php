  ...
  <section class="content">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="hidden" class="form-control" name="id_myfaedah_lainnya" id="id_myfaedah_lainnya" value="<?= $data->id_myfaedah_lainnya ?>" readonly required>
              </div>
              <!-- Nama Cabang -->
              <div class="form-group">
              ...
              <!-- Nama Penyedia lainnya -->
              <div class="form-group">
                <label for="nama_penyedia_lainnya">Nama Penyedia Barang </label>
                <input name="nama_penyedia_lainnya" id="nama_penyedia_lainnya" type="text" class="form-control enable" value="<?= $data->nama_penyedia ?>" readonly required placeholder="Nama Penyedia Barang">
              </div>
              <!-- Jenis Penyedia Barang -->
              <div class="form-group">
                <label for="jenis_penyedia_lainnya">Jenis Penyedia Barang </label>
                <select class="form-control enable" name="jenis_penyedia_lainnya" id="jenis_penyedia_lainnya" required disabled>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input name="nilai_pembiayaan_lainnya" id="nilai_pembiayaan_lainnya" type="number" class="form-control enable" value="<?= $data->nilai_pembiayaan ?>" required readonly>
                </div>
              </div>
              <!-- Informasi Tambahan -->
              <div class="form-group">
                <label for="informasi_tambahan_lainnya">Informasi Tambahan</label>
                <textarea name="informasi_tambahan_lainnya" id="informasi_tambahan_lainnya" cols="30" rows="10" class="form-control enable" readonly><?= $data->informasi_tambahan ?></textarea>
              </div>
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-info" onclick="return confirm('Apakah Anda yakin MENYETUJUI request support ini?')" href="<?= base_url('Admin1/approve/myfaedah/lainnya/' . $data->id_myfaedah_lainnya) ?>">Approve</a>
              <a class="btn btn-danger" onclick="return confirm('Apakah Anda yakin MENOLAK request support ini?')" href="<?= base_url('Admin1/reject/myfaedah/lainnya/' . $data->id_myfaedah_lainnya) ?>">Reject</a>
              <?php } ?>
              <?php if ($this->session->userdata('level') == 3 && $data->id_approval == 2) { ?>

              <a class="btn btn-info" onclick="return confirm('Apakah Anda yakin MENYELESAIKAN request support ini?')" href="<?= base_url('Admin2/complete/myfaedah/lainnya/' . $data->id_myfaedah_lainnya) ?>">Approve</a>
              <a class="btn btn-danger" onclick="return confirm('Apakah Anda yakin MENOLAK request support ini?')" href="<?= base_url('Admin2/reject/myfaedah/lainnya/' . $data->id_myfaedah_lainnya) ?>">Reject</a>
              <?php } ?>
              <!-- Tombol Aksi ini akan muncul untuk Admin Superuser -->
              <?php if ($this->session->userdata('level') == 5) { ?>

              <a class="btn btn-info mt-1" href="<?= base_url('Superuser/complete/myfaedah/lainnya/' . $data->id_myfaedah_lainnya) ?>">Complete</a>
              <a class="btn btn-danger mt-1" href="<?= base_url('Superuser/reject/myfaedah/lainnya/' . $data->id_myfaedah_lainnya) ?>">Reject</a>
              <?php } ?>
            </div>
          </div>
        ...
        <div class="col-lg-6">
          ...
          <div id="upload" class="card">
            ...
            <div class="card-footer text-center">
              <!-- Tombol ini muncul khusus untuk user -->
              <!-- <button type="button" id="ubah" class="btn btn-secondary">Ubah Data</button> -->
              <button type="submit" id="edit_myfaedah_lainnya" class="btn btn-info enable" name="edit_myfaedah_lainnya" disabled>Update Data!</button>
            </div>
            <?php } ?>
            <?php if ($this->session->userdata('level') == 5) { ?>
            <div class="card-footer text-center">
              <!-- Tombol ini muncul khusus untuk SUPERUSER -->
              <button type="submit" id="edit_myfaedah_lainnya_superuser" class="btn btn-info enable" name="edit_myfaedah_lainnya_superuser" disabled>Update Data!</button>
            </div>
            <?php } ?>
          </div>
        </div>
    ...
    <div class="row mt-4">
      <div class="col-lg-12 col-md-6">
        <form method="post" action="<?= base_url('comment/post_comment/id_myfaedah_lainnya') ?>">
          <div class="card">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="hidden" name="id_komentar" value="<?= $data->id_myfaedah_lainnya ?>">
...
<div class="row mt-4">
  <div class="col-lg-12 col-md-12">
    ...
    <div class="card card-widget">
      ...
      <div class="card-footer">
        <!-- Reply comment form -->
        <form action="<?= base_url('comment/post_reply/id_myfaedah_lainnya'); ?>" method="post">
          <div class="img-push">
            <input name="parent_comment" type="hidden" value="<?= $komen->id ?>">
            <input type="hidden" name="id_user" value="<?= $this->fungsi->user_login()->id_user ?>">
            <input name="id_komentar" type="hidden" value="<?= $data->id_myfaedah_lainnya ?>">
            <input type="hidden" name="redirect" value="<?= $this->uri->uri_string() ?>">
