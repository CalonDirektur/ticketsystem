          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input name="nama_penyedia_bangunan" id="nama_penyedia_bangunan" type="text" class="form-control enable" value="<?= $data->nama_penyedia ?>" readonly required placeholder="Nama Penyedia Barang">
              </div>
              <!-- Jenis Penyedia Barang -->
              <div class="form-group">
                <label for="jenis_penyedia_bangunan">Jenis Penyedia Barang </label>
                <select class="form-control enable" name="jenis_penyedia_bangunan" id="jenis_penyedia_bangunan" disabled>
              ...
              <div class="form-group">
                ...
                <input name="luas_bangunan_bangunan" id="luas_bangunan_bangunan" type="text" class="form-control enable" value="<?= $data->luas_bangunan ?>" readonly required placeholder="Luas Bangunan (Panjang x Lebar)">
              </div>
              <!-- Estimasi Waktu -->
              <div class="form-group">
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-info" onclick="return confirm('Apakah Anda yakin MENYETUJUI request support ini?')" href="<?= base_url('Admin1/approve/myfaedah/bangunan/' . $data->id_bangunan) ?>">Approve</a>
              <a class="btn btn-danger" onclick="return confirm('Apakah Anda yakin MENOLAK request support ini?')" href="<?= base_url('Admin1/reject/myfaedah/bangunan/' . $data->id_bangunan) ?>">Reject</a>
              <?php } ?>
              <?php if ($this->session->userdata('level') == 3 && $data->id_approval == 2) { ?>

              <a class="btn btn-info" onclick="return confirm('Apakah Anda yakin MENYELESAIKAN request support ini?')" href="<?= base_url('Admin2/complete/myfaedah/bangunan/' . $data->id_bangunan) ?>">Approve</a>
              <a class="btn btn-danger" onclick="return confirm('Apakah Anda yakin MENOLAK request support ini?')" href="<?= base_url('Admin2/reject/myfaedah/bangunan/' . $data->id_bangunan) ?>">Reject</a>
              <?php } ?>
              <!-- Tombol Aksi ini akan muncul untuk Admin Superuser -->
              <?php if ($this->session->userdata('level') == 5) { ?>

              <a class="btn btn-info mt-1" href="<?= base_url('Superuser/complete/myfaedah/bangunan/' . $data->id_bangunan) ?>">Complete</a>
              <a class="btn btn-danger mt-1" href="<?= base_url('Superuser/reject/myfaedah/bangunan/' . $data->id_bangunan) ?>">Reject</a>
              <?php } ?>
            </div>
          </div>
