          ...
          <div>
            ...
            <div id="card-qurban" class="card kategori-myfaedah pertanyaan mt-4">
              ...
              <div class="card-body">
                ...
                <!-- ID Vendor -->
                <input class="form-control id_vendor" type="hidden" name="id_vendor_qurban" readonly>
                <!-- Nama Vendor -->
                <div class="form-group">
            ...
            <div id="card-myfaedah-lainnya" class="card kategori-myfaedah pertanyaan mt-4">
              ...
              <div class="card-body">
                ...
                <!-- ID Vendor -->
                <input class="form-control id_vendor" type="hidden" name="id_vendor_myfaedah_lainnya" readonly>
                <!-- Nama Vendor -->
                <div class="form-group">
