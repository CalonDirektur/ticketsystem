...
<section class="content">
	<div class="row">
		<div class="col-lg-6">
			<div class="row">
				<img id="gambar" class="img-fluid" src="<?= base_url('uploads/mytalim/' . $data->ktp) ?>" alt="no photo"
					width="550" height="400">
			</div>
			<div class="row">
				<img class="thumb" id="ktp" src="<?= base_url('uploads/mytalim/' . $data->ktp) ?>" alt="no photo" width="50"
					height="50">
				<img class="thumb" id="kk" src="<?= base_url('uploads/mytalim/' . $data->kk) ?>" alt="no photo" width="50"
					height="50">
				<img class="thumb" id="bukti_penghasilan" src="<?= base_url('uploads/mytalim/' . $data->bukti_penghasilan) ?>"
					alt="no photo" width="50" height="50">
				<img class="thumb" id="npwp" src="<?= base_url('uploads/mytalim/' . $data->npwp) ?>" alt="no photo" width="50"
					height="50">
				<img class="thumb" id="tambahan" src="<?= base_url('uploads/mytalim/' . $data->tambahan) ?>" alt="no photo"
					width="50" height="50">
			</div>
		</div>
		<div class="col-lg-6">
					...
					<div class="box-body no-padding">
						<form method="post" action="<?= base_url('ticket_register/edit') ?>" enctype="multipart/form-data">
							<table class="table table-striped">
								...
								<tr>
									<td><b>ID Ticket</b></td>
									<td><input type="text" class="form-control" name="id_mytalim" id="id_mytalim"
											value="<?= $data->id_mytalim ?>" readonly required></td>
								</tr>
								<tr>
									<td><b>Nama Konsumen</b></td>
									<td><input type="text" class="form-control enable" name="nama_konsumen" id="nama_konsumen"
											value="<?= $data->nama_konsumen ?>" readonly required></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text" class="form-control enable" name="nama_lembaga" id="nama_lembaga"
											value="<?= $data->nama_lembaga ?>" readonly required></td>
								</tr>
								<tr>
									<td><b>Tahun Berdiri</b></td>
									<td><input type="text" class="form-control enable" name="tahun_berdiri" id="tahun_berdiri"
											value="<?= $data->tahun_berdiri ?>" readonly required></td>
								</tr>
								<tr>
									<td><b>Akreditasi</b></td>
									<td><input type="text" class="form-control enable" name="akreditasi" id="akreditasi"
											value="<?= $data->akreditasi ?>" readonly required></td>
								</tr>
								<tr>
									<td><b>Tahun Periode</b></td>
									<td><input type="text" class="form-control enable" name="periode" id="periode"
											value="<?= $data->periode ?>" readonly required></td>
								</tr>
								<tr>
									<td><b>Tujuan Pembiayaan</b></td>
									<td><input type="text" class="form-control enable" name="tujuan_pembiayaan" id="tujuan_pembiayaan"
											value="<?= $data->tujuan_pembiayaan ?>" readonly required></td>
								</tr>
								<tr>
									<td><b>Nilai Pembiayaan</b></td>
									<td><input type="text" class="form-control enable" name="nilai_pembiayaan" id="nilai_pembiayaan"
											value="<?= $data->nilai_pembiayaan ?>" readonly required></td>
								</tr>
								<tr>
									<td><b>Status:</b></td>
									<td>
							...
							<tr>
								...
								<td>
									<a class="btn btn-primary"
										href="<?= base_url('Admin1/approve/mytalim/id/' . $data->id_mytalim) ?>">Approve</a>
									<a class="btn btn-danger"
										href="<?= base_url('Admin1/reject/mytalim/id/' . $data->id_mytalim) ?>">Reject</a>
								</td>
							</tr>
							<?php } ?>
							...
							<tr>
								...
								<td>
									<a class="btn btn-primary"
										href="<?= base_url('Admin2/complete/mytalim/id/' . $data->id_mytalim) ?>">Approve</a>
								</td>
							</tr>
							<?php } ?>
							</table>
		...
		<div class="col-lg-12 col-md-6">
			<form method="post" action="<?= base_url('comment/post_comment/id_mytalim') ?>">
				<div class="box">
					...
					<div class="box-body">
						<div class="form-group">
							<textarea class="form-control" name="post_comment" id="post_comment" cols="10" rows="2"
				...
				<div class="box-footer">
					<form action="<?= base_url('comment/post_reply/id_mytalim'); ?>" method="post">
						<div class="img-push">
							...
							<input name="post_reply" type="text" class="form-control input-sm"
