    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <!-- ID Vendor -->
            <input type="hidden" class="form-control id_vendor" name="id_vendor_wo" id="id_vendor_wo" value="<?= $data->id_vendor ?>" readonly required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input name="nama_wo" type="text" class="form-control nama_vendor_myhajat" value="<?= $data->nama_wo ?>" readonly required>
            ...
            <div class="form-group jenis-vendor">
              ...
              <div class="form-check form-check-info">
                <label class="form-check-label"><input class="kategori form-check-input perorangan" type="radio" name="jenis_wo" value="Perorangan" <?= $data->jenis_wo == 'Perorangan' ? 'checked' : '' ?> disabled required>Perorangan</label>
              </div>
              <div class="form-check form-check-info">
                <label class="form-check-label"><input class="kategori form-check-input badan_usaha" type="radio" name="jenis_wo" value="Perusahaan/Badan Usaha" <?= $data->jenis_wo == 'Perusahaan/Badan Usaha' ? 'checked' : '' ?> disabled required>Perusahaan/Badan Usaha</label>
              </div>
            </div>
          ...
          <div class="card-footer">
            ...
            <?php if ($this->session->userdata('level') == 2 && ($data->id_approval == 0 || $data->id_approval == 4)) { ?>
              <a class="btn btn-info" onclick="return confirm('Apakah Anda yakin menyetujui request support?')" href="<?= base_url('Aksi/approve/myhajat/wedding/' . $data->id_wedding) ?>">Approve</a>
              <a class="btn btn-danger" onclick="return confirm('Apakah Anda yakin MENOLAK request support ini?')" href="<?= base_url('Aksi/reject/myhajat/wedding/' . $data->id_wedding) ?>">Reject</a>
            <?php } ?>
            <!-- Tombol Aksi ini akan muncul untuk Admin 1 -->
            <?php if ($this->session->userdata('level') == 3 && $data->id_approval == 2) { ?>
              <a class="btn btn-info" onclick="return confirm('Apakah Anda yakin MENYELESAIKAN request support ini?')" href="<?= base_url('Aksi/complete/myhajat/wedding/' . $data->id_wedding) ?>">Approve</a>
              <a class="btn btn-danger" onclick="return confirm('Apakah Anda yakin MENOLAK request support ini?')" href="<?= base_url('Aksi/reject/myhajat/wedding/' . $data->id_wedding) ?>">Reject</a>
            <?php } ?>
            <!-- Tombol Aksi ini akan muncul untuk Admin Superuser -->
            <?php if ($this->session->userdata('level') == 5) { ?>
              <a class="btn btn-info mt-1" href="<?= base_url('Aksi/complete/myhajat/wedding/' . $data->id_wedding) ?>">Complete</a>
              <a class="btn btn-danger mt-1" href="<?= base_url('Aksi/reject/myhajat/wedding/' . $data->id_wedding) ?>">Reject</a>
            <?php } ?>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-6">
        <div id="upload" class="card">
          <div class="card-header">
            <h3 class="card-title text-center">Lampiran (Attachment) <a class="btn btn-info float-right" href="<?= base_url('zip/createzip/tb_my_hajat_wedding/id_wedding/myhajat/' . $data->id_wedding) ?>">Download All</a></h3>
          </div>
