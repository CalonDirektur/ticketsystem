      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          ...
          <div id="upload" class="card">
            <div class="card-header">
              <h3 class="card-title text-center">Lampiran (Attachment) <a class="btn btn-info float-right" href="<?= base_url('zip/createzip/tb_my_hajat_renovasi/id_renovasi/myhajat/' . $data->id_renovasi) ?>">Download All</a></h3>
            </div>
