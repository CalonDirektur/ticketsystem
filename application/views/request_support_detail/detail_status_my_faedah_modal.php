      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <!-- ID Vendor -->
              <input type="hidden" class="form-control id_vendor" name="id_vendor_modal" id="id_vendor_modal" value="<?= $data->id_vendor ?>" readonly required>
              <!-- Nama Cabang -->
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <input name="nama_penyedia_modal" type="text" class="form-control nama_vendor_myfaedah" value="<?= $data->nama_penyedia ?>" readonly required>
              ...
              <div class="form-group">
                ...
                <select class="form-control jenis-penyedia" name="jenis_penyedia_modal" id="jenis_penyedia_modal" disabled required>
            ...
            <div class="card-footer">
              ...
              <?php if ($this->session->userdata('level') == 2 && ($data->id_approval == 0 || $data->id_approval == 4)) { ?>
                ...
                <a class="btn btn-info" onclick="return confirm('Apakah Anda yakin MENYETUJUI request support ini?')" href="<?= base_url('Aksi/approve/myfaedah/modal/' . $data->id_modal) ?>">Approve</a>
                <a class="btn btn-danger" onclick="return confirm('Apakah Anda yakin MENOLAK request support ini?')" href="<?= base_url('Aksi/reject/myfaedah/modal/' . $data->id_modal) ?>">Reject</a>
              <?php } ?>
              <?php if ($this->session->userdata('level') == 3 && $data->id_approval == 2) { ?>

                <a class="btn btn-info" onclick="return confirm('Apakah Anda yakin MENYELESAIKAN request support ini?')" href="<?= base_url('Aksi/complete/myfaedah/modal/' . $data->id_modal) ?>">Approve</a>
                <a class="btn btn-danger" onclick="return confirm('Apakah Anda yakin MENOLAK request support ini?')" href="<?= base_url('Aksi/reject/myfaedah/modal/' . $data->id_modal) ?>">Reject</a>
              <?php } ?>
              <!-- Tombol Aksi ini akan muncul untuk Admin Superuser -->
              <?php if ($this->session->userdata('level') == 5) { ?>

                <a class="btn btn-info mt-1" href="<?= base_url('Aksi/complete/myfaedah/modal/' . $data->id_modal) ?>">Complete</a>
                <a class="btn btn-danger mt-1" href="<?= base_url('Aksi/reject/myfaedah/modal/' . $data->id_modal) ?>">Reject</a>
              <?php } ?>
            </div>
          </div>
        ...
        <div class="col-lg-6">
          ...
          <div id="upload" class="card">
            <div class="card-header">
              <h3 class="card-title text-center">Lampiran (Attachment) <a class="btn btn-info float-right" href="<?= base_url('zip/createzip/tb_my_faedah_modal/id_modal/myfaedah/' . $data->id_modal) ?>">Download All</a></h3>
            </div>
