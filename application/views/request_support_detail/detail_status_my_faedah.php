          ...
          <div class="card">
            ...
            <div class="card-footer">
              ...
              <?php if ($this->session->userdata('level') == 2 && $data->id_approval == 0) { ?>
                ...
                <a class="btn btn-info" onclick="return confirm('Apakah Anda yakin MENYETUJUI request support ini?')" href="<?= base_url('Aksi/approve/myfaedah/id/' . $data->id_myfaedah) ?>">Approve</a>
                <a class="btn btn-danger" onclick="return confirm('Apakah Anda yakin MENOLAK request support ini?')" href="<?= base_url('Aksi/reject/myfaedah/id/' . $data->id_myfaedah) ?>">Reject</a>
              <?php } ?>
              <?php if ($this->session->userdata('level') == 3 && $data->id_approval == 2) { ?>

                <a class="btn btn-info" onclick="return confirm('Apakah Anda yakin MENYELESAIKAN request support ini?')" href="<?= base_url('Aksi/complete/myfaedah/id/' . $data->id_myfaedah) ?>">Approve</a>
                <a class="btn btn-danger" onclick="return confirm('Apakah Anda yakin MENOLAK request support ini?')" href="<?= base_url('Aksi/reject/myfaedah/id/' . $data->id_myfaedah) ?>">Reject</a>
              <?php } ?>
              <!-- Tombol Aksi ini akan muncul untuk Admin Superuser -->
              <?php if ($this->session->userdata('level') == 5) { ?>

                <a class="btn btn-info mt-1" href="<?= base_url('Aksi/complete/myfaedah/id/' . $data->id_myfaedah) ?>">Complete</a>
                <a class="btn btn-danger mt-1" href="<?= base_url('Aksi/reject/myfaedah/id/' . $data->id_myfaedah) ?>">Reject</a>
              <?php } ?>
            </div>
          </div>
