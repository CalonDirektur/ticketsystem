                ...
                <table id="table-user" class="table responsive status" width="100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <select data-jabatan="<?= $user->id_user ?>" class="form-control" name="jabatan[<?= $user->id_user ?>]" id="jabatan" <?= $user->id_cabang == 46 ? 'disabled' : '' ?>>
                        ...
                        <input data-level="<?= $user->id_user ?>" type="hidden" id="level" name="level[<?= $user->id_user ?>]" value="<?= $user->level ?>" readonly>
                      </td>
                    </tr>
                    <?php
                      $no++;
