							...
							<table class="table">
								...
								<?php if ($this->session->userdata('level') == 2 && $data->id_approval == 0) { ?>
									<tr>
										<td><b>Aksi:</b></td>
										<td>
											<a class="btn btn-primary" href="<?= base_url('Admin1/approve/mysafar/id/' . $data->id_myihram) ?>">Approve</a>
											<a class="btn btn-danger" href="<?= base_url('Admin1/reject/mysafar/id/' . $data->id_myihram) ?>">Reject</a>
										</td>
									</tr>
								<?php } ?>
								<?php if ($this->session->userdata('level') == 3 && $data->id_approval == 2) { ?>
									<tr>
										<td><b>Aksi:</b></td>
										<td>
											<a class="btn btn-primary" href="<?= base_url('Admin2/complete/mysafar/id/' . $data->id_myihram) ?>">Approve</a>
										</td>
									</tr>
								<?php } ?>
							</table>
