				...
				<div class="col-lg-6 col-md-6">
					...
					<div class="card">
						...
						<div class="card-footer">
							...
							<a class="btn btn-info" href="<?= base_url('Admin1/approve/mysafar/id/' . $data->id_mysafar) ?>">Approve</a>
							...
							<a class="btn btn-info" href="<?= base_url('Admin2/complete/mysafar/id/' . $data->id_mysafar) ?>">Approve</a>
