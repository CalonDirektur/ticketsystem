				...
				<div class="col-lg-6">
					...
					<div id="upload" class="card">
						...
						<div class="card-footer text-center">
							<!-- Tombol ini muncul khusus untuk user -->
							<!-- <button type="button" id="ubah" class="btn btn-secondary">Ubah Data</button> -->
							<button type="submit" id="edit_mysafar" class="btn btn-primary enable" name="edit_mysafar" disabled>Update Data!</button>
						</div>
						<?php } ?>
						<?php if ($this->session->userdata('level') == 5) { ?>
						<div class="card-footer text-center">
							<!-- Tombol ini muncul khusus untuk SUPERUSER -->
							<button type="submit" id="edit_mysafar_superuser" class="btn btn-primary enable" name="edit_mysafar_superuser" disabled>Update Data!</button>
						</div>
						<?php } ?>
					</div>
				</div>
