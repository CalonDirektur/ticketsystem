      ...
      <div class="card-body">
        <div class="row">
          ...
          <a href="<?= base_url('status/pending/myhajat/renovasi') ?>">
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-card">
                <span class="info-card-icon bg-red"><img src="<?= base_url('assets/img/my-hajat-82.png') ?>" alt=""></i></span>
                <div class="info-card-content">
                  <span class="info-card-text">My Hajat Renovasi</span>
                  <span class="info-card-number"><?= $pending_myhajat_renovasi ?></span>
                </div>
              </div>
            </div>
          </a>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-card">
                ...
                <div class="info-card-content">
                  ...
                  <span class="info-card-number"><?= $pending_myhajat_sewa ?></span>
                </div>
              </div>
            </div>
          </a>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-card">
                ...
                <div class="info-card-content">
                  ...
                  <span class="info-card-number"><?= $pending_myhajat_wedding ?></span>
                </div>
              </div>
            </div>
          </a>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-card">
                ...
                <div class="info-card-content">
                  ...
                  <span class="info-card-number"><?= $pending_myhajat_franchise ?></span>
                </div>
              </div>
            </div>
          </a>
          ...
          <a href="<?= base_url('status/pending/myhajat/lainnya') ?>">
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-card">
                  <span class="info-card-icon bg-red"><img src="<?= base_url('assets/img/my-hajat-82.png') ?>" alt=""></i></span>
                  <div class="info-card-content">
                    <span class="info-card-text">My Hajat Lainnya</span>
                    <span class="info-card-number"><?= $pending_myhajat_lainnya ?></span>
                  </div>
                </div>
              </div>
            </a>
          ...
          <a href="<?= base_url('status/pending/mytalim') ?>">
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-card">
                <span class="info-card-icon bg-light-blue"><img src="<?= base_url('assets/img/my-talim-82.png') ?>" alt=""></span>
                <div class="info-card-content">
                  <span class="info-card-text">My Ta'lim</span>
                <span class="info-card-number"><?= $pending_mytalim ?></span>
                </div>
              </div>
            </div>
          </a>
