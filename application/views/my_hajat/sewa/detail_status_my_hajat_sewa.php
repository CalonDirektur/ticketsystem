          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control enable" name="nama_pemilik" id="nama_pemilik" value="<?= $data->nama_pemilik ?>" readonly required>
              </div>
              <div class="form-group">
                <label for="">Jenis Pemilik</label>
                <select class="form-control enable" name="jenis_pemilik" id="jenis_pemilik" disabled required>
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-info" onclick="return confirm('Apakah Anda yakin menyetujui request support?')" href="<?= base_url('Admin1/approve/myhajat/sewa/' . $data->id_sewa) ?>">Approve</a>
              <a class="btn btn-danger" onclick="return confirm('Apakah Anda yakin MENOLAK request support ini?')" href="<?= base_url('Admin1/reject/myhajat/sewa/' . $data->id_sewa) ?>">Reject</a>
              <?php } ?>
              <?php if ($this->session->userdata('level') == 3 && $data->id_approval == 2) { ?>

              <a class="btn btn-info" onclick="return confirm('Apakah Anda yakin MENYELESAIKAN request support ini?')" href="<?= base_url('Admin2/complete/myhajat/sewa/' . $data->id_sewa) ?>">Approve</a>
              <a class="btn btn-danger" onclick="return confirm('Apakah Anda yakin MENOLAK request support ini?')" href="<?= base_url('Admin2/reject/myhajat/sewa/' . $data->id_sewa) ?>">Reject</a>
              <?php } ?>
