      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          <div class="card-footer">
            ...
            <a class="btn btn-info" href="<?= base_url('Admin1/approve/myhajat/wedding/' . $data->id_wedding) ?>">Approve</a>
            ...
            <a class="btn btn-info" href="<?= base_url('Admin2/complete/myhajat/wedding/' . $data->id_wedding) ?>">Approve</a>
