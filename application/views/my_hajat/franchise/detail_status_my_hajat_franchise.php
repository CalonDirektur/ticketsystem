      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          <div class="card-footer">
            ...
            <a class="btn btn-info" href="<?= base_url('Admin1/approve/myhajat/franchise/' . $data->id_franchise) ?>">Approve</a>
            ...
            <a class="btn btn-info" href="<?= base_url('Admin2/complete/myhajat/franchise/' . $data->id_franchise) ?>">Approve</a>
